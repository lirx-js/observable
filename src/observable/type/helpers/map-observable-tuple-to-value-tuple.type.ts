import { IGenericObservable, IObservable } from '../observable.type.js';

export type IMapObservableTupleToValueTuple<
  GObservableTuple extends readonly IGenericObservable[],
