import { createNotification } from '../../../../../../misc/notifications/create-notification.js';
import { TInferNotificationGName } from '../../../../../../misc/notifications/notification.type.js';
import { IObserver } from '../../../../../../observer/type/observer.type.js';
import { IObservable, IUnsubscribeOfObservable } from '../../../../../type/observable.type.js';
import { fromEventTarget } from '../../../without-notifications/dom/from-event-target/from-event-target.js';
import { IDragEndNotification } from './notifications/drag-end/drag-end-notification.type.js';
import { IDragMoveNotification } from './notifications/drag-move/drag-move-notification.type.js';
import { IDragStartNotification } from './notifications/drag-start/drag-start-notification.type.js';
import { createPoint2D, IPoint2D } from './point-2d.js';
...
export function createDraggableObservable<GElement extends Element>(
  ...
  return (
    ...
    const pointerDown$ = fromEventTarget<PointerEvent>(element, 'pointerdown');
    const pointerMove$ = fromEventTarget<PointerEvent>(window, 'pointermove');
    const pointerUp$ = fromEventTarget<PointerEvent>(window, 'pointerup');
