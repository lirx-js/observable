...
import { IComposeConstraint } from './types/compose-constraint.type.js';
import { IComposeNowValueConstraint } from './types/compose-now-value-constraint.type.js';
import { IInferComposeNowReturn } from './types/infer-compose-now-return.type.js';
