import {
  mapObservable
} from '../../observable/pipes/built-in/without-notifications/observer-pipe-related/map/map-observable.js';
import { IObservable } from '../../observable/type/observable.type.js';
import {
  createMulticastReplayLastSource,
  IMulticastReplayLastSource
} from '../../observer-observable-pair/build-in/source/built-in/replay-last-source/derived/create-multicast-replay-last-source.js';
